...
/**
 * SxapisagetprocparamsResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SxapisagetprocparamsResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'sxapisagetprocparams_response';
    ...
    protected static $setters = [
        'parameter_list' => 'setParameterList',
    ...
    {
        $this->container['parameter_list'] = isset($data['parameter_list']) ? $data['parameter_list'] : null;
    ...
    {
        return $this->container['parameter_list'];
    }

    /**
     * Sets parameter_list
     *
     * @param string $parameter_list parameter_list
     *
     * @return $this
     */
    public function setParameterList($parameter_list)
    {
        $this->container['parameter_list'] = $parameter_list;
