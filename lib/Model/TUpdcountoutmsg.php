...
/**
 * TUpdcountoutmsg Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TUpdcountoutmsg implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 't-updcountoutmsg';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['runno'] = isset($data['runno']) ? $data['runno'] : null;
        $this->container['whse'] = isset($data['whse']) ? $data['whse'] : null;
        $this->container['prod'] = isset($data['prod']) ? $data['prod'] : null;
        $this->container['messageproc'] = isset($data['messageproc']) ? $data['messageproc'] : null;
    ...
    {
        return $this->container['runno'];
    }

    /**
     * Sets runno
     *
     * @param int $runno runno
     *
     * @return $this
     */
    public function setRunno($runno)
    {
        $this->container['runno'] = $runno;
     ...
     * @return string
     */
    public function getMessageproc()
    {
        return $this->container['messageproc'];
    }

    /**
     * Sets messageproc
     *
     * @param string $messageproc messageproc
     *
     * @return $this
     */
    public function setMessageproc($messageproc)
    {
        $this->container['messageproc'] = $messageproc;
