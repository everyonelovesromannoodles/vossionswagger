<?php
/**
 * SxapisrprocessregrindoutRequest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * SxapisrprocessregrindoutRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SxapisrprocessregrindoutRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'sxapisrprocessregrindout_request';
    ...
    protected static $swaggerTypes = [
        ...
        'product_code' => 'string',
        'warehouse' => 'string',
        'labor_product_code' => 'string',
        'stocking_quantity_ordered' => 'double',
        'vendor_number' => 'double',
        'regrind_number' => 'string',
        't_srdefaultdata' => '\Swagger\Client\Model\TSrdefaultdataReq',
    ...
    protected static $swaggerFormats = [
        ...
        'product_code' => null,
        'warehouse' => null,
        'labor_product_code' => null,
        'stocking_quantity_ordered' => 'double',
        'vendor_number' => 'double',
        'regrind_number' => null,
        't_srdefaultdata' => null,
        't_infieldvalue' => null
    ];
    ...
    protected static $setters = [
        ...
        'labor_product_code' => 'setLaborProductCode',
        'stocking_quantity_ordered' => 'setStockingQuantityOrdered',
        'vendor_number' => 'setVendorNumber',
        'regrind_number' => 'setRegrindNumber',
        't_srdefaultdata' => 'setTSrdefaultdata',
    ...
    protected static $getters = [
        ...
        'labor_product_code' => 'getLaborProductCode',
        'stocking_quantity_ordered' => 'getStockingQuantityOrdered',
        'vendor_number' => 'getVendorNumber',
        'regrind_number' => 'getRegrindNumber',
        't_srdefaultdata' => 'getTSrdefaultdata',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['labor_product_code'] = isset($data['labor_product_code']) ? $data['labor_product_code'] : null;
        ...
        $this->container['regrind_number'] = isset($data['regrind_number']) ? $data['regrind_number'] : null;
        $this->container['t_srdefaultdata'] = isset($data['t_srdefaultdata']) ? $data['t_srdefaultdata'] : null;
    ...
    /**
     * Gets labor_product_code
     *
     * @return string
     */
    public function getLaborProductCode()
    {
        return $this->container['labor_product_code'];
    }

    /**
     * Sets labor_product_code
     *
     * @param string $labor_product_code labor_product_code
     *
     * @return $this
     */
    public function setLaborProductCode($labor_product_code)
    {
        $this->container['labor_product_code'] = $labor_product_code;
     ...
     * @return string
     */
    public function getRegrindNumber()
    {
        return $this->container['regrind_number'];
    }

    /**
     * Sets regrind_number
     *
     * @param string $regrind_number regrind_number
     *
     * @return $this
     */
    public function setRegrindNumber($regrind_number)
    {
        $this->container['regrind_number'] = $regrind_number;

        return $this;
    }

    /**
     * Gets t_srdefaultdata
     *
     * @return \Swagger\Client\Model\TSrdefaultdataReq
     */
    public function getTSrdefaultdata()
    {
        return $this->container['t_srdefaultdata'];
    }

    /**
     * Sets t_srdefaultdata
     *
     * @param \Swagger\Client\Model\TSrdefaultdataReq $t_srdefaultdata t_srdefaultdata
     *
     * @return $this
     */
    public function setTSrdefaultdata($t_srdefaultdata)
    {
        $this->container['t_srdefaultdata'] = $t_srdefaultdata;
