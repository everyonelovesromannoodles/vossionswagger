...
/**
 * SxapixmlprocessingResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SxapixmlprocessingResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'sxapixmlprocessing_response';
    ...
    {
        $this->container['xml_reply'] = isset($data['xml_reply']) ? $data['xml_reply'] : null;
    ...
    {
        return $this->container['xml_reply'];
    }

    /**
     * Sets xml_reply
     *
     * @param string $xml_reply xml_reply
     *
     * @return $this
     */
    public function setXmlReply($xml_reply)
    {
        $this->container['xml_reply'] = $xml_reply;
