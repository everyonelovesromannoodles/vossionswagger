...
/**
 * Sxapicustomcallv2Response Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Sxapicustomcallv2Response implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'sxapicustomcallv2_response';
    ...
    {
        $this->container['out_data'] = isset($data['out_data']) ? $data['out_data'] : null;
     ...
     * Sets out_data
     *
     * @param string $out_data out_data
     *
     * @return $this
     */
