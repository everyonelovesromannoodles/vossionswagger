<?php
/**
 * SxapisfvalidatecustomerResponse
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * SxapisfvalidatecustomerResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SxapisfvalidatecustomerResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'sxapisfvalidatecustomer_response';
    ...
    protected static $setters = [
        'valid_customer' => 'setValidCustomer',
    ...
    protected static $getters = [
        'valid_customer' => 'getValidCustomer',
    ...
    {
        $this->container['valid_customer'] = isset($data['valid_customer']) ? $data['valid_customer'] : null;
    ...
    {
        return $this->container['valid_customer'];
    }

    /**
     * Sets valid_customer
     *
     * @param bool $valid_customer valid_customer
     *
     * @return $this
     */
    public function setValidCustomer($valid_customer)
    {
        $this->container['valid_customer'] = $valid_customer;
