...
/**
 * SxapiarcreatetransactionResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SxapiarcreatetransactionResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'sxapiarcreatetransaction_response';
    ...
    {
        $this->container['ar_trans'] = isset($data['ar_trans']) ? $data['ar_trans'] : null;
     ...
     * @return string
     */
    public function getArTrans()
    {
        return $this->container['ar_trans'];
    }

    /**
     * Sets ar_trans
     *
     * @param string $ar_trans ar_trans
     *
     * @return $this
     */
    public function setArTrans($ar_trans)
    {
        $this->container['ar_trans'] = $ar_trans;
