...
/**
 * SxapisrallowtiecancelResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SxapisrallowtiecancelResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'sxapisrallowtiecancel_response';
    ...
    protected static $attributeMap = [
        'allow_tie_cancel' => 'allowTieCancel',
        'ordered_stage' => 'orderedStage',
    ...
    protected static $setters = [
        'allow_tie_cancel' => 'setAllowTieCancel',
        'ordered_stage' => 'setOrderedStage',
    ...
    protected static $getters = [
        'allow_tie_cancel' => 'getAllowTieCancel',
        'ordered_stage' => 'getOrderedStage',
    ...
    {
        $this->container['allow_tie_cancel'] = isset($data['allow_tie_cancel']) ? $data['allow_tie_cancel'] : null;
        $this->container['ordered_stage'] = isset($data['ordered_stage']) ? $data['ordered_stage'] : null;
    ...
    /**
     * Gets allow_tie_cancel
     *
     * @return bool
     */
    public function getAllowTieCancel()
    {
        return $this->container['allow_tie_cancel'];
    }

    /**
     * Sets allow_tie_cancel
     *
     * @param bool $allow_tie_cancel allow_tie_cancel
     *
     * @return $this
     */
    public function setAllowTieCancel($allow_tie_cancel)
    {
        $this->container['allow_tie_cancel'] = $allow_tie_cancel;
     ...
     * @return bool
     */
    public function getOrderedStage()
    {
        return $this->container['ordered_stage'];
    }

    /**
     * Sets ordered_stage
     *
     * @param bool $ordered_stage ordered_stage
     *
     * @return $this
     */
    public function setOrderedStage($ordered_stage)
    {
        $this->container['ordered_stage'] = $ordered_stage;
