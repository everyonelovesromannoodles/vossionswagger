<?php
/**
 * Sxapiicgetwhseproductdataunitsv2Response
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * Sxapiicgetwhseproductdataunitsv2Response Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Sxapiicgetwhseproductdataunitsv2Response implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'sxapiicgetwhseproductdataunitsv2_response';
    ...
    protected static $swaggerTypes = [
        ...
        'unit_warehouse_transfer' => 'string'
    ];
    ...
    protected static $attributeMap = [
        ...
        'unit_warehouse_transfer' => 'unitWarehouseTransfer'
    ];
    ...
    protected static $setters = [
        ...
        'unit_warehouse_transfer' => 'setUnitWarehouseTransfer'
    ];
    ...
    protected static $getters = [
        ...
        'unit_warehouse_transfer' => 'getUnitWarehouseTransfer'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['unit_buy'] = isset($data['unit_buy']) ? $data['unit_buy'] : null;
        $this->container['unit_standard'] = isset($data['unit_standard']) ? $data['unit_standard'] : null;
        $this->container['unit_warehouse_transfer'] = isset($data['unit_warehouse_transfer']) ? $data['unit_warehouse_transfer'] : null;
    }
    ...
    {
        return $this->container['unit_buy'];
    }

    /**
     * Sets unit_buy
     *
     * @param string $unit_buy unit_buy
     *
     * @return $this
     */
    public function setUnitBuy($unit_buy)
    {
        $this->container['unit_buy'] = $unit_buy;
    ...
    /**
     * Gets unit_warehouse_transfer
     *
     * @return string
     */
    public function getUnitWarehouseTransfer()
    {
        return $this->container['unit_warehouse_transfer'];
    }

    /**
     * Sets unit_warehouse_transfer
     *
     * @param string $unit_warehouse_transfer unit_warehouse_transfer
     *
     * @return $this
     */
    public function setUnitWarehouseTransfer($unit_warehouse_transfer)
    {
        $this->container['unit_warehouse_transfer'] = $unit_warehouse_transfer;
