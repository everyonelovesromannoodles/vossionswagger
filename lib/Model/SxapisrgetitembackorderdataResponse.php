<?php
/**
 * SxapisrgetitembackorderdataResponse
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * SxapisrgetitembackorderdataResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SxapisrgetitembackorderdataResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'sxapisrgetitembackorderdata_response';
    ...
    protected static $swaggerTypes = [
        'tt_bo_list' => '\Swagger\Client\Model\TtBOListResp',
    ...
    {
        $this->container['tt_bo_list'] = isset($data['tt_bo_list']) ? $data['tt_bo_list'] : null;
     ...
     * Gets tt_bo_list
     *
     * @return \Swagger\Client\Model\TtBOListResp
     */
    public function getTtBoList()
    {
        return $this->container['tt_bo_list'];
    }

    /**
     * Sets tt_bo_list
     *
     * @param \Swagger\Client\Model\TtBOListResp $tt_bo_list tt_bo_list
     *
     * @return $this
     */
    public function setTtBoList($tt_bo_list)
    {
        $this->container['tt_bo_list'] = $tt_bo_list;
