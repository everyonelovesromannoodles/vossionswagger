...
/**
 * TIneqtenderdata Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TIneqtenderdata implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 't-ineqtenderdata';
    ...
    {
        $this->container['tendertype'] = isset($data['tendertype']) ? $data['tendertype'] : null;
    ...
    {
        return $this->container['tendertype'];
    }

    /**
     * Sets tendertype
     *
     * @param string $tendertype tendertype
     *
     * @return $this
     */
    public function setTendertype($tendertype)
    {
        $this->container['tendertype'] = $tendertype;
